...
public:
    ...
    ShapeNode* find(const string& name) const; // finds a shape node with the specified shape name
    ...
    ShapeNode* remove(const string& name);     // removes the node with the shape called name
